...
double HccPileUp::getPUWeight(TH1D* h_pileup, int ntrue)
{
    return h_pileup->GetBinContent(ntrue+1);
}

double HccPileUp::getPUWeight(double nInteraction, std::string version)
{
  ...
  if(version == "ICHEP52X") return weightTruePileupV07toIchep52X(nInteraction);
    ...
    std::string msg;
    msg = "HccPileUp::getPUWeight() unknown version\n";
...
double HccPileUp::weightTruePileupV07toIchep52X(double input){
  double w[60] = {
    2.59113e-07,
    1.77107e-05,
    0.0263017,
...
double HccPileUp::weightTruePileupV07toHcp53X(double input){
  double w[60] = {
    0.0447136,     
    0.11785,       
    0.23825,
...
double HccPileUp::weightTruePileupV10toIchep53X(double input){
  double w[60] = {
    2.35693e-06,
    7.51928e-05,
    0.0263529,
...
double HccPileUp::weightTruePileupV10toHcp53X(double input){
  double w[60] = {
    0.409409,
    0.527276,
    0.39328,
...
double HccPileUp::weightTruePileupMoriond53X(double input){
...
double HccPileUp::weightTruePileupLegacy53X(double input){
...
double HccPileUp::weightTruePileupFall15_74X(double input){
...
double HccPileUp::weightTruePileupFall15_76X(double input){
...
double HccPileUp::weightTruePileupSpring16_80X(double input){
...
double HccPileUp::weightTruePileupSummer16_80X(double input){
...
double HccPileUp::weightTrue2011(double input){
  if(input>50) 
    return 1;
...
double HccPileUp::weightTrue2011to2012(double input){
  if(input>50) 
    return 1;
