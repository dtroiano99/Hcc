...
HccGENAna::HccGENAna(TString Treename)
{
...
int HccGENAna::MotherID(const reco::GenParticle* p){
    int ID = 0;
...
int HccGENAna::MotherMotherID(const reco::GenParticle* p){
    int ID = 0;
    int nMo = p->numberOfMothers();
    const reco::Candidate* g= (const reco::Candidate*)p;
    while (nMo>0) {
...
bool HccGENAna::IsMotherZ(const reco::GenParticle* p){
	bool yes = false;
	int nMo = p->numberOfMothers();
	const reco::Candidate* g= (const reco::Candidate*)p;
	while (nMo>0) {
...
bool HccGENAna::IsMotherW(const reco::GenParticle* p){
        bool yes = false;
        int nMo = p->numberOfMothers();
        const reco::Candidate* g= (const reco::Candidate*)p;
        while (nMo>0) {
...
bool HccGENAna::IsMotherT(const reco::GenParticle* p){
        bool yes = false;
        int nMo = p->numberOfMothers();
        const reco::Candidate* g= (const reco::Candidate*)p;
        while (nMo>0) {
...
bool HccGENAna::IsMotherH(const reco::GenParticle* p){
    bool yes = false;
    int nMo = p->numberOfMothers();
    const reco::Candidate* g= (const reco::Candidate*)p;
    while (nMo>0) {
...
bool HccGENAna::IsFSR(const reco::GenParticle* p, int id){
    bool yes = false;
    int nMo = p->numberOfMothers();
    const reco::Candidate* g= (const reco::Candidate*)p;
...
bool HccGENAna::IsMotherStatus3EorMu(const reco::GenParticle* p){
    bool yes = false;
    int nMo = p->numberOfMothers();
    const reco::Candidate* g= (const reco::Candidate*)p;
...
void HccGENAna::getMotherZ(const reco::GenParticle* p, double &px, double &py, double &pz, double &E)
{
  bool done = false;
  int nMo = p->numberOfMothers();
  const reco::Candidate* g= (const reco::Candidate*)p;
...
bool HccGENAna::getMotherH(const reco::GenParticle* p) // only lepton from Higgs
{
  bool done = false;
  int nMo = p->numberOfMothers();
  const reco::Candidate* g= (const reco::Candidate*)p;
...
void HccGENAna::getStatusThree(const reco::GenParticle* p, TLorentzVector &pv, int pdgid, int &id)
{
  bool done = false;
  int nMo = p->numberOfMothers();
  const reco::Candidate* g= (const reco::Candidate*)p;
...
void HccGENAna::fillGenEvent(edm::Handle<reco::GenParticleCollection> genParticles,std::vector<reco::GenParticle> &Higgs, 
		  std::vector<reco::GenParticle> &Zs, 
		  std::vector<reco::GenParticle> &leptonsS1, std::vector<reco::GenParticle> &leptonsS3, std::vector<bool> &isFromHiggs, std::vector<bool> &isFromW)
{
...
void HccGENAna::fillGenTree(edm::Handle<reco::GenParticleCollection> genParticles)
{
...
void HccGENAna::fillTreeVariables(std::vector<reco::GenParticle> Higgs, 
		       std::vector<reco::GenParticle> Zs, 
		       std::vector<reco::GenParticle> leptonsS1, std::vector<reco::GenParticle> leptonsS3)
{
...
void HccGENAna::printDecayList(edm::Handle<reco::GenParticleCollection> particles){
