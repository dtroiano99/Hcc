...
'/store/mc/Run3Summer23MiniAODv4/Zto2Q-4Jets_HT-800_TuneCP5_13p6TeV_madgraphMLM-pythia8/MINIAODSIM/130X_mcRun3_2023_realistic_v14-v1/30000/56116074-423c-4035-bcb4-5e5d8edffb1c.root',
)
...
process.TFileService = cms.Service("TFileService",
                                   ...
                                   fileName = cms.string("MC_2023C.root")
)
...
process.jec_ak4 = cms.ESSource("PoolDBESSource",
                           #for hpc
                           #CondDB.clone(connect = cms.string("sqlite_file:" +os.environ.get('CMSSW_BASE')+"/src/Hcc/HccAna/data/Summer23Prompt23_V1_MC.db")),
                           #for crab
...
process.jec_ak8 = cms.ESSource("PoolDBESSource",
                               ...
                               toGet =  cms.VPSet(
                                  cms.PSet(
                                     record = cms.string("JetCorrectionsRecord"),
                                     tag = cms.string("JetCorrectorParametersCollection_Summer23Prompt23_V1_MC_AK8PFPuppi"),
...
process.Ana = cms.EDAnalyzer('HccAna',
                              ...
                              #for hpc
                              #uncertainty_source_path_src = cms.untracked.string(os.environ.get('CMSSW_BASE')+"/src/Hcc/HccAna/data/Summer23Prompt23_V1_MC_UncertaintySources_AK4PFPuppi.txt"),
                              #for crab
                              uncertainty_source_path_src = cms.untracked.string("Summer23Prompt23_V1_MC_UncertaintySources_AK4PFPuppi.txt"),
                             )
