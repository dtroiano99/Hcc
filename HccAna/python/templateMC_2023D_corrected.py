...
process.GlobalTag.globaltag='130X_mcRun3_2023_realistic_postBPix_v2' #MC2023
...
'/store/mc/Run3Summer23BPixMiniAODv4/Zto2Q-4Jets_HT-800_TuneCP5_13p6TeV_madgraphMLM-pythia8/MINIAODSIM/130X_mcRun3_2023_realistic_postBPix_v2-v1/40000/7f6a1a39-1f12-4eae-88e6-5bd6cd01546c.root',
)
...
process.TFileService = cms.Service("TFileService",
                                   ...
                                   fileName = cms.string("MC_2023D.root")
)
...
process.jec_ak4 = cms.ESSource("PoolDBESSource",
                           #for hpc
                           #CondDB.clone(connect = cms.string("sqlite_file:" +os.environ.get('CMSSW_BASE')+"/src/Hcc/HccAna/data/Summer23BPixPrompt23_V1_MC.db")),
                           #for crab
                           CondDB.clone(connect = cms.string("sqlite_file:Summer23BPixPrompt23_V1_MC.db")),
                           toGet =  cms.VPSet(
                              cms.PSet(
...
process.jec_ak8 = cms.ESSource("PoolDBESSource",
                               ...
                               toGet =  cms.VPSet(
                                  cms.PSet(
                                     record = cms.string("JetCorrectionsRecord"),
                                     tag = cms.string("JetCorrectorParametersCollection_Summer23BPixPrompt23_V1_MC_AK8PFPuppi"),
...
updateJetCollection(
   ...
   jetCorrections = ('AK8PFPuppi', cms.vstring(['L1FastJet', 'L2Relative', 'L3Absolute']), 'None')  # Update: Safe to always add 'L2L3Residual' as MC contains dummy L2L3Residual corrections (always set to 1)
)
...
updateJetCollection(
   ...
   jetCorrections = ('AK4PFPuppi', cms.vstring(['L1FastJet', 'L2Relative', 'L3Absolute']), 'None')  # Update: Safe to always add 'L2L3Residual' as MC contains dummy L2L3Residual corrections (always set to 1)
)
...
process.Ana = cms.EDAnalyzer('HccAna',
                              ...
                              #for hpc
                              #uncertainty_source_path_src = cms.untracked.string(os.environ.get('CMSSW_BASE')+"/src/Hcc/HccAna/data/Summer23BPixPrompt23_V1_MC_UncertaintySources_AK4PFPuppi.txt"),
                              #for crab
                              uncertainty_source_path_src = cms.untracked.string("Summer23BPixPrompt23_V1_MC_UncertaintySources_AK4PFPuppi.txt"),
                             )
