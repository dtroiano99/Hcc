...
'/store/data/Run2022E/JetMET/MINIAOD/22Sep2023-v1/30000/0009ca4f-e9fa-4146-a780-e6eb893b023a.root',
)
...
process.jec_ak4 = cms.ESSource("PoolDBESSource",
                           CondDBSetup,
                           # for HPC
                           #connect = cms.string("sqlite_file:/afs/cern.ch/user/d/dtroiano/BARI/AK8Tagger/CMSSW_13_0_13/src/Hcc/HccAna/python/Summer22EE_22Sep2023_RunE_V2_DATA.db"),
                           #for crab
                           connect = cms.string("sqlite_file:src/Hcc/HccAna/python/Summer22EE_22Sep2023_RunE_V2_DATA.db"),
                           toGet =  cms.VPSet(
                              cms.PSet(
                                 record = cms.string("JetCorrectionsRecord"),
                                 tag = cms.string("JetCorrectorParametersCollection_Summer22EE_22Sep2023_RunE_V2_DATA_AK4PFPuppi"),
...
process.jec_ak8 = cms.ESSource("PoolDBESSource",
                               ...
                               toGet =  cms.VPSet(
                                  cms.PSet(
                                     record = cms.string("JetCorrectionsRecord"),
                                     tag = cms.string("JetCorrectorParametersCollection_Summer22EE_22Sep2023_RunE_V2_DATA_AK8PFPuppi"),
