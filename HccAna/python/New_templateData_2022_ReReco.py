...
'/store/data/Run2022C/JetMET/MINIAOD/22Sep2023-v1/2530000/08f285fd-506b-40de-a0e2-28a611411ff4.root',
)
...
process.TFileService = cms.Service("TFileService",
                                   fileName = cms.string("New_Data2022_ReReco.root")
)
...
process.jec_ak4 = cms.ESSource("PoolDBESSource",
                           ...
                           toGet =  cms.VPSet(
                              cms.PSet(
                                 ...
                                 tag = cms.string("JetCorrectorParametersCollection_Summer22_22Sep2023_RunCD_V2_DATA_AK4PFPuppi"),
...
process.jec_ak8 = cms.ESSource("PoolDBESSource",
                               ...
                               toGet =  cms.VPSet(
                                  cms.PSet(
                                     record = cms.string("JetCorrectionsRecord"),
                                     tag = cms.string("JetCorrectorParametersCollection_Summer22_22Sep2023_RunCD_V2_DATA_AK8PFPuppi"),
