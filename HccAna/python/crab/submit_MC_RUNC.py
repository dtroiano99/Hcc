...
config.JobType.psetName = "../templateMC_2023C_corrected.py"
config.JobType.numCores = 2
basepath = os.getenv('CMSSW_BASE')+'/src/Hcc/HccAna'
config.JobType.inputFiles = [basepath+'/data/Summer23Prompt23_V1_MC.db', basepath+'/data/Summer23Prompt23_V1_MC_UncertaintySources_AK4PFPuppi.txt']
