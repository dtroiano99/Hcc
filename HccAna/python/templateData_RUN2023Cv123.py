...
process.TFileService = cms.Service("TFileService",
                                   fileName = cms.string("Data_2023Cv123.root")
)
...
process.jec_ak4 = cms.ESSource("PoolDBESSource",
                           #for hpc
                           #CondDB.clone(connect = cms.string("sqlite_file:" +os.environ.get('CMSSW_BASE')+"/src/Hcc/HccAna/data/Summer23Prompt23_RunCv123_V1_DATA.db")),
                           #for crab
                           CondDB.clone(connect = cms.string("sqlite_file:Summer23Prompt23_RunCv123_V1_DATA.db")),
                           toGet =  cms.VPSet(
                              cms.PSet(
...
process.jec_ak8 = cms.ESSource("PoolDBESSource",
                               ...
                               toGet =  cms.VPSet(
                                  cms.PSet(
                                     record = cms.string("JetCorrectionsRecord"),
                                     tag = cms.string("JetCorrectorParametersCollection_Summer23Prompt23_RunCv123_V1_DATA_AK8PFPuppi"),
