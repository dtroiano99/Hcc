...
'/store/data/Run2022G/JetMET/MINIAOD/22Sep2023-v2/2560000/019504df-c54e-4db3-8d83-dc1df66a0fa0.root',
)
...
process.jec_ak4 = cms.ESSource("PoolDBESSource",
                           ...
                           toGet =  cms.VPSet(
                              cms.PSet(
                                 ...
                                 tag = cms.string("JetCorrectorParametersCollection_Summer22EE_22Sep2023_RunG_V2_DATA_AK4PFPuppi"),
...
process.jec_ak8 = cms.ESSource("PoolDBESSource",
                               ...
                               toGet =  cms.VPSet(
                                  cms.PSet(
                                     record = cms.string("JetCorrectionsRecord"),
                                     tag = cms.string("JetCorrectorParametersCollection_Summer22EE_22Sep2023_RunG_V2_DATA_AK8PFPuppi"),
